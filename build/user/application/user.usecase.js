...
var UserUseCase = /** @class */ (function () {
    ...
    UserUseCase.prototype.registerUser = function (_a) {
        var name = _a.name, email = _a.email, description = _a.description;
        return __awaiter(this, void 0, void 0, function () {
            var userValue, userCreated;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        userValue = new user_value_1.UserValue({ name: name, email: email, description: description });
    ...
    UserUseCase.prototype.listOfUsers = function () {
        return __awaiter(this, void 0, void 0, function () {
            var users;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.userRepository.listOfUsers()];
                    case 1:
                        users = _a.sent();
